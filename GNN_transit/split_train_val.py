...
if __name__ == "__main__":
    ...
    with open("./tsp-data/tsp{}_val_concorde.txt".format(opts.num_nodes), "w", encoding="utf-8") as f:
        for line in val_data:
            f.write(line)
    
    # Create separate train data file
    with open("./tsp-data/tsp{}_train_concorde.txt".format(opts.num_nodes), "w", encoding="utf-8") as f:
